...
namespace LibDmd.Output.DeviceNeutral
{
	...
	public class FixedSizeDeviceNeutralDestination : DeviceNeutralDestination, IFixedSizeDestination
	{
		...
		public FixedSizeDeviceNeutralDestination(IDeviceNeutralTransport transport, DeviceNeutralMessageWriter writer, byte panel, byte[] connectBytes, IEnumerable<DeviceNeutralMessageType> messages, Dimensions fixedSize)
