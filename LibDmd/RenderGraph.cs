...
namespace LibDmd
{
	...
	public class RenderGraph : IRenderer
	{
		...
		public IDisposable StartRendering(Action onCompleted, Action<Exception> onError = null)
		{
			...
			try {
				...
				foreach (var dest in Destinations) {
					...
					var destColoredGray2 = Accepting<IColoredGray2Destination>(dest, FrameFormat.ColoredGray2);
					var destColoredGray4 = Accepting<IColoredGray4Destination>(dest, FrameFormat.ColoredGray4);
					var destColoredGray6 = Accepting<IColoredGray6Destination>(dest, FrameFormat.ColoredGray6);
					var destRgb565 = Accepting<IRgb565Destination>(dest, FrameFormat.Rgb565);
					var destRgb24 = Accepting<IRgb24Destination>(dest, FrameFormat.Rgb24);
					var destBitmap = Accepting<IBitmapDestination>(dest, FrameFormat.Bitmap);
					var destAlphaNumeric = Accepting<IAlphaNumericDestination>(dest, FrameFormat.AlphaNumeric);
					...
					var destGray2 = Accepting<IGray2Destination>(dest, FrameFormat.Gray2);
					var destGray4 = Accepting<IGray4Destination>(dest, FrameFormat.Gray4);
					var destGray8 = Accepting<IGray8Destination>(dest, FrameFormat.Gray8);
		...
		private static T Accepting<T>(IDestination dest, FrameFormat format) where T : class
		{
